...
<fieldset
    ...
    <input
        ...
        class="bpmpi_auth_suppresschallenge"
        value="false" />
    <input
        type="hidden"
    ...
    <input
        ...
        class="bpmpi_brand_establishment_code"
